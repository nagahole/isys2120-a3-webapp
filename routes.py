...
def login():
    ...
    if request.method == "POST":
        ...
        session['is_admin'] = logins[0]['is_admin']
...
def list_users():
    ...
    return render_template('users/list_users.html', page=page, session=session, users=users_listdict)
...
def list_consolidated_users():
    ...
    return render_template('users/list_consolidated_users.html', page=page, session=session, users=users_userroles_listdict)
...
def list_user_stats():
    ...
    return render_template('users/list_user_stats.html', page=page, session=session, users=user_stats)
...
def update_user():
    ...
    # TODO Need a check for is_admin
